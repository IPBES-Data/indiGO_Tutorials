...
#install and load Indicator Analysis Package
...
Trends over time in comparison o a pristine world can be examined using the `plot_percentageRemaining()` function, while changes since 1970 can be assessed with `plot_changeSince1970()`, displaying the globally aggregated value standardized to a percentage or relative to its 1970 value.
